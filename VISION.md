...
ROSE is the AI that actually does things.
...
ROSE started as a personal playground to learn AI and build something genuinely useful:
an assistant that can run real tasks on a real computer.
It evolved through several names and shells: Warelay -> Clawdbot -> Moltbot -> ROSE.
...
Security in ROSE is a deliberate tradeoff: strong defaults without killing capability.
...
ROSE has an extensive plugin API.
...
- Code plugins run ROSE plugin code and are appropriate for deeper runtime extension.
...
ROSE docs should document core extension points; plugin promotion belongs in ClawHub, preferably under vetted org publishers for official plugins.
...
ROSE supports MCP as both a server and a runtime integration surface.
...
ROSE is currently terminal-first by design.
...
ROSE is primarily an orchestration system: prompts, tools, protocols, and integrations.
TypeScript was chosen to keep ROSE hackable by default.
